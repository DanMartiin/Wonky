      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            <Link href="/booking" className="inline-block text-[12px] tracking-wider border border-gray-600 px-5 py-2 rounded text-gray-700 hover:bg-gray-50 transition-colors">
              RESERVE NOW
            </Link>
          </div>
        </div>
