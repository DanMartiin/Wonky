    ...
    <footer className="w-full bg-[#112921] text-white">
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-5 ml-auto md:ml-0">
          ...
          <Link href="#" aria-label="Facebook" className="inline-flex w-11 h-11 items-center justify-center rounded-lg bg-white text-[#112921] transition hover:opacity-90">
          ...
          <Link href="#" aria-label="Instagram" className="inline-flex w-11 h-11 items-center justify-center rounded-lg bg-white text-[#112921] transition hover:opacity-90">
