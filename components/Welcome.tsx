    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          {/* Images */}
          <div className="relative order-2 lg:order-1 h-[531px]">
          ...
          {/* Copy */}
          <div className="order-1 lg:order-2 lg:pl-8 flex flex-col justify-center h-[531px]">
            <div className="text-start">
              <div className="uppercase tracking-wider text-xs text-gray-600 mb-2">Welcome to</div>
              <h2 className="text-3xl md:text-4xl font-semibold text-[#1f2e1a] mb-4 border-b border-gray-300 pb-2">Wonky Walden Book Nook</h2>
