...
export async function sendVerificationEmail(email: string, token: string): Promise<void> {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: 'Verify Your Booking - Wonky Walden Book Nook',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #166534;">Wonky Walden Book Nook</h2>
        ...
        <p>Best regards,<br>The Wonky Walden Team</p>
      </div>
    `,
  };
...
export async function sendConfirmationEmail(data: EmailData): Promise<void> {
  const mailOptions = {
    from: process.env.EMAIL_USER || 'noreply@wonkymalden.com',
    to: data.email,
    subject: 'Booking Confirmed - Wonky Walden Book Nook',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>We look forward to welcoming you to Wonky Walden Book Nook!</p>
        <p>Best regards,<br>The Wonky Walden Team</p>
      </div>
    `,
  };
...
export async function sendAdminNotification(data: EmailData): Promise<void> {
  ...
  const mailOptions = {
    from: process.env.EMAIL_USER || 'noreply@wonkymalden.com',
    to: adminEmail,
    subject: 'New Booking - Wonky Walden Book Nook',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
